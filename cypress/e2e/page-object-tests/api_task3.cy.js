...
describe('Login', () => {
    ...
    before('Get token', () => {
        ...
        cy.api(RequestData.getToken(body)).then((response) => {
    ...
    it('Add car', () => {
        ...
        cy.api(RequestData.addCar(carBody, token))
            .then((response) => {
    ...
    it('Get car by Id: exist', () => {
        cy.api(RequestData.getCarById(carId, token))
            .then((response) => {
    ...
    it('Add expense by carId', () => {
        ...
        cy.api(RequestData.addExpense(expenseBody, token))
            .then((response) => {
                expect(response.status).to.eq(200);
    ...
    it('Get extense by Id', () => {
        cy.api(RequestData.getExpenseById(expenseId, token))
            .then((response) => {
                expect(response.status).to.eq(200);
    ...
    it('Edit expense by Id', () => {
        ...
        cy.api(RequestData.editExpenseById(expenseId, expenseBody, token))
            .then((response) => {
                expect(response.status).to.eq(200);
            })
    });
    ...
    it('Get all extenses by carId and page number', () => {
        cy.api(RequestData.getAllExpenses(carId, 1, token))
            .then((response) => {
                expect(response.status).to.eq(200);
    ...
    it('Remove expense by Id', () => {
        cy.api(RequestData.removeExpense(expenseId, token)).then((response) => {
            expect(response.status).to.eq(200);
        })
    });
    ...
    it('Remove car', () => {
        cy.api(RequestData.removeCar(carId, token)).then((response) => {
            expect(response.status).to.eq(200);
        })
    });
    it('Get car by Id: deleted', () => {
        cy.api(RequestData.getCarById(carId, token)).then((response) => {
